/**
 * Компонент MaterialSettings
 * 
 * Отвечает за настройки материалов, такие как масштабирование текстуры,
 * интенсивность карты нормалей и другие параметры материала.
 * Позволяет точно настроить внешний вид выбранного материала.
 * 
 * Этот компонент был отключен в текущей версии приложения.
 */
