/**
 * Компонент MeshSelector - выбор конкретной сетки для выбранного узла
 * 
 * Позволяет выбрать одну из доступных сеток (вариантов геометрии)
 * для выбранного узла модели. Например, для узла "сиденье" могут быть
 * различные варианты формы сидений.
 * 
